...
public class InfoScreen extends Screen {
    ...
    /** Toast: epoch-ms until which the "Copied!" badge stays on the Copy event.button(). */
    ...
    public void render(GuiGraphics g, int mx, int my, float delta) {
        ...
        // Header: back event.button() (left) + title (center) + open-web-event.button() (right)
        ...
        if (loginCode != null) {
            ...
            if (secsLeft <= 0) {
                ...
                rowY += 12;
                // Code display box on the LEFT, Copy event.button() on the RIGHT.
                // Geometry: code box (px+12, rowY, ..., rowY+18); Copy event.button()
                ...
                // Copy event.button(), flips to "Copied!" for 1.5s after click.
